/*******************************************************************************
* File Name: Simple_TL_Control_1_Count7_1.c
* Version 1.0
*
* Description:
...
#include "Simple_TL_Control_1_Count7_1.h"

uint8 Simple_TL_Control_1_Count7_1_initVar = 0u;


/*******************************************************************************
* Function Name: Simple_TL_Control_1_Count7_1_Init
********************************************************************************
*
* Summary:
...
void Simple_TL_Control_1_Count7_1_Init(void) 
{
    ...
    Simple_TL_Control_1_Count7_1_PERIOD_REG = Simple_TL_Control_1_Count7_1_INITIAL_PERIOD;
}


/*******************************************************************************
* Function Name: Simple_TL_Control_1_Count7_1_Enable
********************************************************************************
*
* Summary:
...
void Simple_TL_Control_1_Count7_1_Enable(void) 
{
    ...
    */
    Simple_TL_Control_1_Count7_1_AUX_CONTROL_REG |= Simple_TL_Control_1_Count7_1_COUNTER_START;
...
/*******************************************************************************
* Function Name: Simple_TL_Control_1_Count7_1_Start
********************************************************************************
*
* Summary:
...
*
* Global Variables:
*  Simple_TL_Control_1_Count7_1_initVar - global variable.
*
* Return:
*  None.
*
...
void Simple_TL_Control_1_Count7_1_Start(void) 
{
    ...
    if(Simple_TL_Control_1_Count7_1_initVar == 0u)
    {
        Simple_TL_Control_1_Count7_1_Init();
        Simple_TL_Control_1_Count7_1_initVar = 1u;
    }

    /* Enable Count7 */
    Simple_TL_Control_1_Count7_1_Enable();
}


/*******************************************************************************
* Function Name: Simple_TL_Control_1_Count7_1_Stop
********************************************************************************
*
* Summary:
...
void Simple_TL_Control_1_Count7_1_Stop(void) 
{
    ...
    Simple_TL_Control_1_Count7_1_AUX_CONTROL_REG &= (uint8) ~((uint8) Simple_TL_Control_1_Count7_1_COUNTER_START);
...
/*******************************************************************************
* Function Name: Simple_TL_Control_1_Count7_1_WriteCounter
********************************************************************************
*
* Summary:
...
{
    Simple_TL_Control_1_Count7_1_COUNT_REG = (count & Simple_TL_Control_1_Count7_1_COUNT_7BIT_MASK);
}


/*******************************************************************************
* Function Name: Simple_TL_Control_1_Count7_1_ReadCounter
********************************************************************************
*
* Summary:
...
{
    return(Simple_TL_Control_1_Count7_1_COUNT_REG & Simple_TL_Control_1_Count7_1_COUNT_7BIT_MASK);
}


/*******************************************************************************
* Function Name: Simple_TL_Control_1_Count7_1_WritePeriod
********************************************************************************
*
* Summary:
...
{
    Simple_TL_Control_1_Count7_1_PERIOD_REG = period;
}


/*******************************************************************************
* Function Name: Simple_TL_Control_1_Count7_1_ReadPeriod
********************************************************************************
*
* Summary:
...
{
    return(Simple_TL_Control_1_Count7_1_PERIOD_REG);
}
