...
#define Change_In_0_PS		(Change_In__0__PS)
#define Change_In_0_PC		(Change_In__0__PC)
#define Change_In_0_DR		(Change_In__0__DR)
#define Change_In_0_SHIFT	(Change_In__0__SHIFT)
#define Change_In_0_INTR	((uint16)((uint16)0x0003u << (Change_In__0__SHIFT*2u)))
