...
assign Datapath_1_select[0] = (ThreeSec_TC);
assign Datapath_1_select[1] = (OneSec_TC);
assign Datapath_1_select[2] = (1'b0);
assign Count7_1_en = (1'b1);
assign Count7_1_load = (1'b0);
assign Count7_1_reset = (1'b0);
...
parameter Datapath_1_dpconfig0 = 
{
    ...
    `CS_ALU_OP__DEC, `CS_SRCA_A0, `CS_SRCB_D0, `CS_SHFT_OP_PASS, `CS_A0_SRC__ALU, `CS_A1_SRC_NONE, `CS_FEEDBACK_DSBL, `CS_CI_SEL_CFGA, `CS_SI_SEL_CFGA, `CS_CMP_SEL_CFGA,  /*CFGRAM2: Decrement Count */
    `CS_ALU_OP_PASS, `CS_SRCA_A0, `CS_SRCB_D0, `CS_SHFT_OP_PASS, `CS_A0_SRC___D0, `CS_A1_SRC_NONE, `CS_FEEDBACK_DSBL, `CS_CI_SEL_CFGA, `CS_SI_SEL_CFGA, `CS_CMP_SEL_CFGA,  /*CFGRAM3: Reload Counter */
